const insertModel = $("#product-insert-model");
  ...
  parentHandles.click(function (e) {
    if (childHandles.hasClass("hidden")) {
      childHandles.removeClass("hidden");

      $(this).html(`
      ${categoryIcons.caretDown}
      <span class="ml-2 text-violet-400">Parent 3</span>
      `);
    } else {
      childHandles.addClass("hidden");

      $(this).html(`
      ${categoryIcons.caretRight}
      <span class="ml-2 text-violet-400">Parent 3</span>
      `);
    }
  });
