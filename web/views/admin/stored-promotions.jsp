            ...
            <div class="flex justify-between pt-3">
              ...
              <div class="flex gap-4">
                ...
                <div>
                  <a
                    href="#"
                    class="-btn group block rounded-lg p-2 px-4 bg-white ring-1 ring-slate-900/5 shadow-lg space-y-3 hover:bg-sky-500 hover:ring-sky-500"
                  >
              ...
              <table class="text-white w-full font-">
                ...
                >
                  <tr>
                    ...
                    <th class="py-2 px-4 text-center w-14">ID</th>
                    <th class="py-2 px-4 w-40">PROMOTION NAME</th>
                    <th class="py-2 px-4 w-36">CATEGORY</th>
                    <th class="py-2 px-4 text-center w-24">DISCOUNT RATE</th>
                    <th class="py-2 px-4 text-center w-32">START</th>
                    <th class="py-2 px-4 text-center w-32">END</th>
                ...
                <tbody>
                  ...
                  <tr class="border-b border-gray-700 even:bg-slate-800">
                    ...
                    <td class="py-2 px-4 text-center">${promotion.getPromotionId()}</td>
                    <td class="py-2 px-4">
                    ...
                    <td class="py-2 px-4">
                      <span class="text-sm text-center block font-bold">${promotion.getStartDate()}</span>
                    </td>
                    <td class="py-2 px-4">
                      <span class="text-sm text-center block font-bold">${promotion.getEndDate()}</span>
                    </td>
                    <td class="py-2 px-4">
                    ...
                    <td class="py-2 px-4 text-center">
                      <div>
                        ...
                        <button
                          ...
                          class="view-promotion-btn p-2 cursor-pointer text-gray-400 fill-gray-400"
                        >
                          <p class="text-xl">
