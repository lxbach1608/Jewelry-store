              ...
              <table class="text-white w-full font-">
                ...
                <c:forEach var="product" items="${products}">
                    <tr class="border-b border-gray-700">
                        ...
                        <td class="py-2 px-4">
                          <span class="text-xs block text-center">Selling</span>
                        </td>
                        <td class="py-2 px-4">
                          <a href="#">
...
<!--<h1>Products</h1>
        ...
        <form action="<c:url value="/products/create"/>" method="POST">
            ...
            <input type="text" name="name" value="<c:out value=""/>" placeholder="name"/>
            <br>
            <label>Description</label>
            <input type="text" name="description" value="<c:out value=""/>" placeholder="description"/>
...
<!--        <div>
                <h1>CREATE product</h1>
                <form id="productForm" action="<c:url value="products/create" />" method="POST">
                    <input type="hidden" name="action" value="createProduct"/>

                    <lable style="display: inline-block; width: 80px">Name</lable>
                    <input type="text" name="name">
                    <br>
                    <lable style="display: inline-block; width: 80px">Description</lable>
                    <input type="text" name="desc">
                    <br>
                    <lable style="display: inline-block; width: 80px">Price</lable>
                    <input type="text" name="price">
                    <br>
                    <lable style="display: inline-block; width: 80px">Image</lable>
                    <input type="text" name="imgUrl">
                    <br>
                    <lable style="display: inline-block; width: 80px">Slug</lable>
                    <input type="text" name="slug">
                    <br>
                    <lable style="display: inline-block; width: 80px">size</lable>
                    <select name="size">
                    ...
                    <br>
                    <lable style="display: inline-block; width: 80px">Color</lable>
                    <select name="color">
                    ...
                    <ul>
                        <c:forEach var="child" items="${children}">
                            <li>
                                <input type="checkbox" name="childCheckbox" value="${child.getCategoryId()}">${child.getName()}</input>
                            </li>
                        </c:forEach>
                    </ul>
